document.addEventListener('DOMContentLoaded', () => {
    ...
    const API_BASE_URL = "https://skin-mate1-17.onrender.com";
    ...
    analyzeButton.addEventListener('click', async () => {
        ...
        try {
            ...
            // --- MODIFICATION START ---
            // Advanced formatting for subheadings and points
            ...
            lines.forEach(line => {
                ...
                if (trimmedLine.startsWith('* ') || trimmedLine.startsWith('- ')) {
                    ...
                    // Remove the bullet character for clean list item
                    ...
                    // Check for subheadings (ending with :)
            ...
            // Close any list that might be open at the end
            if (isInsideList) {
                formattedHtml += '</ul>';
            }

            analysisResultDiv.innerHTML = formattedHtml || `<p>${analysisText}</p>`; // Fallback
            // --- MODIFICATION END ---
